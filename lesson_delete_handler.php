...
//
//$deleteLessonTitle = trim($_POST['deleteLessonTitle']);
//
//$functions = new Dao();
...
//if (empty($deleteLessonTitle)) {
//    $lessonDeleteMessages['bad'][] = "Please enter the document TITLE";
//} else {
//    // Check if the image exists in the database
//    if (!$functions->documentExists($deleteLessonTitle)) {
//        $lessonDeleteMessages['bad'][] = "Document not found in the database, please enter a document that is in the database.";
//    } else {
//        // If the image exists, delete it
//        if (!$functions->deleteDocument($deleteLessonTitle)) {
//            $lessonDeleteMessages['bad'][] = "Error deleting the image from the database.";
//        }
//    }
//}
//
